...
fn load() -> Vec<crate::routeguide::Feature> {
...
async fn main() -> anyhow::Result<()> {
    ...
    let pool = MySqlPool::connect(&"mysql://gduwooafpmieabqdmy8f:pscale_pw_o8VMOQya4f6Soz7uiLela2UXJaQi9tLJrOmzblUn9n5@aws.connect.psdb.cloud/splitter").await?;
    ...
    let r = client::client().await;
    match r {
        Ok(r) => r,
        Err(e) => print!("Err occured:{e}"),
    }
    Ok(())
}
